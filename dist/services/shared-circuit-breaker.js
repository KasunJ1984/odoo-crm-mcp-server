...
export function getSharedCircuitBreaker() {
    if (!sharedBreaker) {
        sharedBreaker = new CircuitBreaker(CIRCUIT_BREAKER_CONFIG.FAILURE_THRESHOLD, CIRCUIT_BREAKER_CONFIG.RESET_TIMEOUT_MS, CIRCUIT_BREAKER_CONFIG.HALF_OPEN_MAX_ATTEMPTS);
 ...
 */
export function getSharedCircuitBreakerState() {
 ...
 */
export function getSharedCircuitBreakerMetrics() {
    return getSharedCircuitBreaker().getMetrics();
}
//# sourceMappingURL=shared-circuit-breaker.js.map